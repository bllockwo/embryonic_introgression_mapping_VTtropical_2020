...
#2R: 20,551,633 and X: 15607604

plink --ld "2R_20551633_SNP" "X_15607604_SNP" --vcf $va_vcf --allow-extra-chr --double-id

plink --ld "2R_16439138_SNP" "X_15501637_SNP" --vcf $dgrp_vcf --allow-extra-chr --double-id
