#!/usr/bin/env bash
#
#SBATCH -J nonWF_intro # A single job name for the array
#SBATCH -c 1
#SBATCH -N 1 # on one node
#SBATCH -t 19:00:00 #<= this may depend on your resources
...
mkdir nonWFintro_output/${chr}_${startw}_${endw}_nonWFintro
...
-d "ith=${i}" \
introgression_neutral_nonWF.6_4_2024.slim
done
